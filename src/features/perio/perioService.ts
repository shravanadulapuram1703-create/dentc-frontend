...
// Per-exam provider used to live here in localStorage (`perio:exam_provider`)
// until the backend added `PerioExam.provider_id` (PERIO-BE-14, 2026-09-11).
// The exam row is now the only source; nothing is remembered client-side.
