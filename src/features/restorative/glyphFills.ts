...
const SYMBOL_RE = /(DECAY|CARIES|CHIP|CRACK|FRACTURE|BROKEN|ABRASION|EROSION|BRUXISM|LESION|FLUOROSIS|DEMINERAL|HYPOCALC|HYPOPLASIA|GEMINATION|FUSED|FUSION|DISCOLOR|STAIN|CONCUSSION|TRAUMA|PINS|PARAPULPAL|PARTIALLY_ERUPT|ANKYLOSIS|ECTOPIC|ROTATED|PERICORONITIS|OPEN_MARGIN|ORTHO|BRACES|SPLINT|SPACER|INTRUSION|ERUPT|IMPACT|DRIFT|TIPPED|RCT|ROOT_CANAL|ENDO|GUTTA|INFECTION|PARL|ABSCESS|PERIAPICAL|FISTULA|APICO|RESORPTION|ROOT_TIP|PULP_STONE|EXTRACT|REMOVAL|AVULSION|CONGEN|LOOSE|RETAINED|MISSING|IMPLANT|WATCH|MOBILITY|FURCATION|RECESSION)/;
