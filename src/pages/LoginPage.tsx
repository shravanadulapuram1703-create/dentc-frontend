...
//             <Activity className="w-8 h-8 text-white" strokeWidth={2.5} />
//           </div>
//           <h1 className="text-3xl font-bold text-[#1F3A5F] mb-2">Dental Practice Management</h1>
//           <p className="text-[#475569] font-medium">Sign in to your account</p>
//         </div>
...
//             <button
//               type="submit"
//               className="w-full py-3.5 px-6 rounded-lg bg-gradient-to-r from-[#3A6EA5] to-[#5A8EC5] text-white font-bold text-base shadow-md hover:shadow-lg hover:from-[#2d5684] hover:to-[#4A7EB5] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2"
//             >
//               <LogIn className="w-5 h-5" strokeWidth={2.5} />
//               Sign In
//             </button>
...
//           <p className="text-xs text-[#1F3A5F] font-semibold mb-2">👨‍💻 Testing Roles:</p>
//           <p className="text-xs text-[#1F3A5F]/80">
//             Use email: <code className="bg-white px-1.5 py-0.5 rounded font-mono border border-[#E2E8F0]">owner@test.com</code> (Owner), 
//             <code className="bg-white px-1.5 py-0.5 rounded font-mono border border-[#E2E8F0] ml-1">admin@test.com</code> (Admin), 
//             <code className="bg-white px-1.5 py-0.5 rounded font-mono border border-[#E2E8F0] ml-1">manager@test.com</code> (Manager), 
//             <code className="bg-white px-1.5 py-0.5 rounded font-mono border border-[#E2E8F0] ml-1">doctor@test.com</code> (Doctor), 
//             or <code className="bg-white px-1.5 py-0.5 rounded font-mono border border-[#E2E8F0] ml-1">staff@test.com</code> (Staff)
//           </p>
//           <p className="text-xs text-[#2FB9A7] font-semibold mt-2">
//             💡 Use <strong>owner@test.com</strong> to access Organization Management
//           </p>
